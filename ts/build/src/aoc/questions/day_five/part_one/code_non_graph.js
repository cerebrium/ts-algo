...
exports.day_five_non_graph_part_one = void 0;
function day_five_non_graph_part_one(orderings, data) {
    let answer = 0;
    const order_map = new Map();
    const valid_list = new Array(data.length).fill(false);
...
exports.day_five_non_graph_part_one = day_five_non_graph_part_one;
//# sourceMappingURL=code_non_graph.js.map