...
const kaitensushi_1 = require("../../questions/leet_code/kaitensushi");
test('kaitensushi', () => {
    const n = 6;
    const d = [1, 2, 3, 3, 2, 1];
    const k = 1;
    const maxDishes = (0, kaitensushi_1.getMaximumEatenDishCount)(n, d, k);
...
//# sourceMappingURL=kaitensushi.test.js.map