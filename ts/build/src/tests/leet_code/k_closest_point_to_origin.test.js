...
const k_closest_point_to_origin_1 = require("../../questions/leet_code/k_closest_point_to_origin");
// Explanation:
...
test('k_closest_point_to_origin', () => {
    ...
    const k = 3;
    const res = (0, k_closest_point_to_origin_1.kClosest)(points, k);
    const output = [
        [-4, -7],
        [-4, -8],
        [-2, 10],
...
//# sourceMappingURL=k_closest_point_to_origin.test.js.map