...
const code_1 = require("../../aoc/questions/day_two/part_one/code");
const code_2 = require("../../aoc/questions/day_two/part_two/code");
test('day_two_part_one', () => {
    const answer = (0, code_1.day_two_part_one)(day_two_full_data);
    expect(answer).toBe(236);
});
test('day_two_part_two', () => {
    const answer = (0, code_2.day_two_part_two)(day_two_full_data);
    expect(answer).toBe(308);
});
const day_two_test_data = [
    [7, 6, 4, 2, 1],
    [1, 2, 7, 8, 9],
    [9, 7, 6, 2, 1],
    [1, 3, 2, 4, 5],
...
//# sourceMappingURL=day_two.test.js.map