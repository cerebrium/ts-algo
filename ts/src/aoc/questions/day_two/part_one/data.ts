export const day_two_part_one_data = [
  [74, 76, 78, 79, 76], // greater success 1 0
  [38, 40, 43, 44, 44], // greater success 2 1
  [1, 2, 4, 6, 8, 9, 13], //graeter success 3 2
  [65, 68, 70, 72, 75, 76, 81], // greater success 4 3
  [89, 91, 92, 95, 93, 94], // greater success 5 4
  [15, 17, 16, 18, 19, 17], // greater fail 5
  [46, 47, 45, 48, 51, 52, 52], // greater fail 6
  [77, 78, 79, 82, 79, 83], // greater fail 7
  [55, 58, 59, 57, 60, 61, 68], // greater fail 8
  [79, 82, 84, 84, 85, 86], // greate success 9
  [23, 24, 25, 25, 23], // greater fail 10
  [23, 26, 27, 28, 31, 31, 31], // greater fail 11
  [42, 43, 43, 44, 48], // greater fail 12
  [72, 74, 74, 77, 82], // greater fail 13
  [85, 86, 87, 88, 89, 93, 94], // greater success 6 14
  [48, 50, 51, 53, 57, 59, 62, 61], // greater fail 15
  [29, 32, 34, 38, 38], // greater fail 16
  [71, 73, 75, 78, 82, 85, 88, 92], // greater fail 17
  [1, 4, 7, 8, 12, 18], // greater fail 18
  [16, 17, 20, 25, 27, 30, 33], // greater success 7 19
  [49, 52, 55, 62, 63, 66, 68, 67], // greater fail 20
  [69, 71, 74, 76, 78, 80, 85, 85], // greater fail 21
  [34, 36, 39, 42, 48, 49, 53], // greater fail 22
  [48, 51, 52, 55, 61, 67], // greater fail 23
  [55, 54, 57, 60, 61],
