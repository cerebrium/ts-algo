import {day_two_part_one} from '../../aoc/questions/day_two/part_one/code';
import {day_two_part_two} from '../../aoc/questions/day_two/part_two/code';

test('day_two_part_one', () => {
  const answer = day_two_part_one(day_two_full_data);

  expect(answer).toBe(236);
});

test('day_two_part_two', () => {
  const answer = day_two_part_two(day_two_full_data);
