import {DayFive} from '../../aoc/questions/day_five/part_one/code';
import {day_five_non_graph_part_two} from '../../aoc/questions/day_five/part_two/code';

test('aoc_day_five_part_one', () => {
  const day_five = new DayFive(
